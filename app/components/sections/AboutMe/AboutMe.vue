...
<template>
  <div id="aboutMe" class="section page-2">
    <div class="section max-w-[1200px]">
      <h1>
        {{ t("portfolio.aboutMe") }}
      </h1>
      ...
      <div class="flex mt-36 flex-col xl:flex-row gap-32">
        <div v-for="section in sections" :key="section.title" class="relative sm:w-[500px] xl:w-1/4">
          <div
            class="h-full p-16 pt-36 rounded-xl flex flex-col items-center card-color light-effect"
          >
            <div
              class="absolute top-[-30px] h-60 w-60 flex items-center justify-center border rounded-full shadow-md card-color light-effect"
            >
